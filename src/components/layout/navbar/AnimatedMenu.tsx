...
const NavLink = ({
  ...
  return (
    <motion.a
      ...
      exit={{ opacity: 0, y: -8 }}
      href={href}
      className="0 block text-2xl font-semibold text-foreground transition-colors hover:text-primary md:text-3xl"
    >
      {children}
    </motion.a>
  );
...
const Logo = () => {
  ...
  return (
    <motion.a
      ...
      className="h-16 w-16"
    >
      <Image src={logo} alt="logo" className="h-16 w-16 object-contain" />
    </motion.a>
  );
};
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed z-10 rounded-xl bg-background shadow-lg shadow-violet-800/20"
      />
